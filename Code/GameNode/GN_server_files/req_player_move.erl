...
-export[handle_player_movement/3, insert_player_movement/3, check_for_obstacles/4].
...
-include_lib("project_env/src/Playing_with_Fire_2-Earlang/Code/GameNode/mnesia_records.hrl"). %% windows fix
...
handle_player_movement_clearance(PlayerNum, Answer, Table_name) ->
    ...
    case Answer of
        can_move ->
            ...
            insert_player_movement(PlayerNum, Table_name, Player_record#mnesia_players.direction);
